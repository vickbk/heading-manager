...
describe("writeStepSummary", () => {
  ...
  let scopedWriteStepSummary = writeStepSummary;
  beforeEach(async () => {
    vi.resetModules();
    vi.restoreAllMocks();

    scopedWriteStepSummary = (await import("./write-step-summary"))
      .writeStepSummary;
  });
  ...
  describe("Environment Variable Handling", () => {
    it("should not invoke fs.appendFileSync when GITHUB_STEP_SUMMARY environment variable is undefined", () => {
      ...
      scopedWriteStepSummary("No coverage summary file found.");
